.. only:: html
   ...
   .. image:: https://img.shields.io/github/commits-since/Tatsh/usps-track/v0.0.5/master
      :target: https://github.com/Tatsh/usps-track/compare/v0.0.5...master
   ...
   .. image:: https://results.pre-commit.ci/badge/github/Tatsh/usps-track/master.svg
      :target: https://results.pre-commit.ci/latest/github/Tatsh/usps-track/master
